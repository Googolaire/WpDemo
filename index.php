<!DOCTYPE html>
	...
	<title>Hunter M. - Freelance Web Developer and Marketing Specialist</title> 
			...
			<div class="branding">
				...
				<div class="logo-container">
					...
					<div class="name-container">
						<h1 class="logo"><a href="index.html">Hunter M.</a></h1>
						<h2 class="title">Developer & Marketer</h2>
					</div>
				</div>
			</div>
				<nav>
                ...
                <!-- Here is gonnna be the php for wordpress header -->
		</header>
			...
			<section class="left clever-box">
				<div class="rationale">
					<div class="rationale-heading-middle">
						...
						<p>I have 3 years full immersive self study of HTML5, CSS, Javascript as well as related technologies. I have six years marketing experiance. From SEO to print ads. I was in college for marketing, worked on a seated senetors campaign, as well as a winning mayor. I have worked with several non-profits. </p>
						<p class="last">My main focus beyond building a stunning portfolio full of pleased clients is using technology to help free childeren in haiti from the regulations required to hold class and ease the times when a teacher isn't avaliable. Or by aiding the teacher with more curiculam at their finger tips.</p>
					<div class="buttons">
				...
				<footer>
					...
					<div class="three">
						...
						<ul>
							...
							<li>312-404-2430</li>
							<li class="last">chris.lam.unt@gmail.com</li>
